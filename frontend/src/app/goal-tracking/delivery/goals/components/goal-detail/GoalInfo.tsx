// GoalInfo.tsx
import { Goal, GoalFormData, Space, User } from "@/app/goal-tracking/delivery/goals/utils/types"
...
// Función auxiliar para verificar si un goal está vencido
const isGoalOverdue = (dueDate: string | undefined, status: string) => {
  return dueDate && status !== 'completado' && new Date(dueDate) < new Date()
}
          ...
          <div className="flex items-center gap-4">
            {isEditing ? (
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary" className={`${getGoalStatusConfig(goal.status as any)?.bgColor || 'bg-gray-500'} text-white`}>
