import { TeamMemberCardProps } from "@/app/team-collaboration/delivery/team/utils/teamUtils"
import { avatarVariants, badgeVariants, buttonVariants, cardVariants, progressBarVariants, progressFillVariants, statsVariants } from "@/app/team-collaboration/delivery/team/utils/variants"
...
// Función simple para colores de roles
const getRoleColor = (role: string) => {
    switch (role) {
        case "administrador": return "bg-red-500"
        case "miembro": return "bg-blue-500"
        case "espectador": return "bg-gray-500"
        default: return "bg-gray-500"
    }
}


export function TeamMemberCard({ user, stats }: TeamMemberCardProps) {
  return (
    <motion.div
